    ...
    <div className="container mx-auto px-4 py-12">
      <nav aria-label="Breadcrumb" className="text-sm text-muted-foreground mb-6">
        <ol className="flex items-center gap-2">
          <li><Link href="/" className="hover:text-foreground">{t.contact.breadcrumbHome}</Link></li>
          <li aria-hidden="true">/</li>
          <li className="text-foreground font-medium" aria-current="page">{t.contact.breadcrumbContact}</li>
        </ol>
      </nav>
        ...
        <div className="space-y-8">
          <dl className="space-y-4">
            <div className="flex gap-3">
              ...
              <div>
                <dt className="font-medium text-sm">{t.contact.addressLabel}</dt>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <dt className="font-medium text-sm">{t.contact.phoneLabel}</dt>
                <dd className="mt-0.5">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <dt className="font-medium text-sm">{t.contact.emailLabel}</dt>
                <dd className="mt-0.5">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <dt className="font-medium text-sm">{t.contact.hoursLabel}</dt>
                <dd className="text-sm text-muted-foreground mt-0.5 space-y-0.5">
                  <p>{t.contact.hoursMonFri}</p>
